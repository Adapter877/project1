...
<section class="playlist-form">
   ...
   <h1 class="heading">สร้างเพลย์ลิสต์</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="ป้อนชื่อเพลย์ลิสต์" class="box">
      ...
      <input type="submit" value="สร้างเพลย์ลิสต์" name="submit" class="btn">
   </form>
