...
<section class="playlists">
   ...
   <h1 class="heading">เพิ่มเพลย์ลิสต์</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">สร้างเพลย์ลิสต์ใหม่</h3>
         <a href="add_playlist.php" class="btn">เพิ่มเพลย์ลิสต์</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">อัปเดต</a>
            <input type="submit" value="ลบ" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">ดูเพลย์ลิสต์</a>
      </div>
      <?php
         } 
      }else{
