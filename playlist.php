   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>บันทึก</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>บันทึกเพลย์ลิสต์ไว้</span></button>
            <?php
               }
            ?>
         </form>
         <div class="thumb">
            <span><?= $total_videos; ?> วิดีโอ</span>
      ...
      <?php
            ...
            echo '<p class="empty">ไม่พบเพลย์ลิสต์นี้!</p>';
         }  
      ?>
