...
<section class="edit-comment">
   <h1 class="heading">แก้ไขความคิดเห็น</h1>
   <form action="" method="post">
      <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="กรุณาใส่ความคิดเห็นของคุณ" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">ยกเลิกแก้ไข</a>
         <input type="submit" value="อัปเดตตอนนี้" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="watch-video">
   ...
   <?php
      ...
      if($select_content->rowCount() > 0){
         while($fetch_content = $select_content->fetch(PDO::FETCH_ASSOC)){
            ...
            $exam_link = $fetch_content['exam_link'];
   ?>
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">กลับ</a>
         <a href="<?= $exam_link; ?>" target="_blank" class="inline-btn">ทำข้อสอบ</a>
         <?php
   ...
   <?php
         ...
         echo '<p class="empty">ยังไม่มีการเพิ่มวิดีโอ!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading">เพิ่มความคิดเห็น</h1>
   ...
   <form action="" method="post" class="add-comment">
      ...
      <input type="submit" value="เพิ่มความคิดเห็น" name="add_comment" class="inline-btn">
   </form>
